...
import CodeWithBeki.com.HomeUserPage;
...
public class DisplayAvailableBooksUser extends HomePage {
    private JTable dispBooks;
    private JScrollPane scroll;
    private JComboBox sortSearch;

    public DisplayAvailableBooksUser() {
        super();
        /*try {
    ...
    public void edditButton() {
        pathTextField.setText(">Home user>available books");
